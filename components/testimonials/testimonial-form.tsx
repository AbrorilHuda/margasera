...
export function TestimonialForm() {
    ...
    try {
      ...
      if (res.booking) {
        ...
        setFormData((prev) => ({
          ...
          contact: b.instagram ? (b.instagram.startsWith('@') ? b.instagram : `@${b.instagram}`) : (b.whatsapp || prev.contact),
        }));
      } else {
        setCodeError(
  ...
  return (
    <div className="w-full flex flex-col gap-6">
      ...
      {!isSubmitted && (
        <div className="p-5 sm:p-6 bg-white dark:bg-zinc-900/80 border border-zinc-200/90 dark:border-zinc-800/90 rounded-2xl shadow-xs">
          <div className="flex items-start gap-3.5 mb-4">
            <div className="w-9 h-9 rounded-xl bg-[#0066CC]/10 text-[#0066CC] dark:text-blue-400 flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 font-light mt-0.5 leading-relaxed">
                Masukkan kode pemesanan (contoh: <span className="font-mono font-medium text-zinc-700 dark:text-zinc-300">MS-260815-123</span>) agar data nama, layanan, dan lokasi Anda otomatis terisi.
              </p>
            </div>
          </div>
          ...
          {verifiedBooking ? (
            ...
            <div className="p-4 bg-emerald-50/80 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="text-xs text-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-200 flex items-center gap-1.5 transition-colors cursor-pointer shrink-0"
              >
            ...
            >
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 bg-zinc-50/70 dark:bg-zinc-950/70 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm font-mono text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 placeholder:font-sans focus:outline-none focus:border-[#0066CC] transition-colors"
                />
              </div>
              <button
                type="submit"
                disabled={isCheckingCode}
                className="px-5 py-3 bg-[#0066CC] hover:bg-[#0052A3] disabled:opacity-50 text-white text-xs font-semibold tracking-wider uppercase rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shrink-0"
              >
                {isCheckingCode ? (
                  <>
          ...
          {codeError && (
            <p className="text-xs text-rose-600 dark:text-rose-400 font-light mt-2.5">
              {codeError}
            </p>
          )}
        </div>
      ...
      <AnimatePresence mode="wait">
        {isSubmitted ? (
          <motion.div
            ...
            className="p-8 sm:p-14 bg-white dark:bg-zinc-900/90 border border-zinc-200/90 dark:border-zinc-800 rounded-3xl text-center shadow-lg dark:shadow-[0_0_50px_rgba(0,102,204,0.08)] flex flex-col items-center gap-6"
          >
            ...
            <motion.div
              ...
              className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-emerald-100 dark:bg-emerald-950/80 border-2 border-emerald-500/60 dark:border-emerald-500/60 flex items-center justify-center text-emerald-600 dark:text-emerald-400 shadow-md shadow-emerald-500/15 my-2"
            >
              <CheckCircle2 className="w-9 h-9 sm:w-11 sm:h-11" />
            </motion.div>

            <div className="max-w-lg flex flex-col items-center">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900/50 text-emerald-700 dark:text-emerald-400 text-[10px] font-semibold tracking-widest uppercase mb-2">
              ...
              <p className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 font-light mt-3 leading-relaxed max-w-md">
                Cerita dan ulasan hangat Anda untuk dokumentasi <span className="font-medium text-zinc-900 dark:text-zinc-200">{formData.eventType}</span> telah berhasil kami terima. Apresiasi Anda menjadi energi dan kebanggaan bagi tim Margasera Photography di Pamekasan &amp; Madura.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-md pt-4">
              ...
              <Link
                href="/work"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800/80 dark:hover:bg-zinc-800 text-zinc-800 dark:text-zinc-200 text-xs font-semibold tracking-wider uppercase rounded-xl border border-zinc-200/80 dark:border-zinc-700/60 transition-all duration-300 cursor-pointer"
              >
          ...
          <motion.form
            ...
            exit={{ opacity: 0, y: -15 }}
            className="p-6 sm:p-10 md:p-12 bg-white dark:bg-zinc-900/80 border border-zinc-200/90 dark:border-zinc-800/90 rounded-2xl shadow-sm dark:shadow-[0_0_35px_rgba(0,102,204,0.06)] flex flex-col gap-6"
          >
            {errorMessage && (
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-zinc-50/70 dark:bg-zinc-950/70 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-[#0066CC] dark:focus:border-[#0066CC] transition-colors placeholder:text-zinc-400 font-sans"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-zinc-50/70 dark:bg-zinc-950/70 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-[#0066CC] dark:focus:border-[#0066CC] transition-colors font-sans cursor-pointer"
                >
                  {SERVICES.map((s) => (
            ...
            <div className="flex flex-col gap-2 p-5 bg-zinc-50/80 dark:bg-zinc-950/50 border border-zinc-200/80 dark:border-zinc-800/80 rounded-xl">
              ...
              <div className="flex items-center gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <Star
                      className={`w-7 h-7 sm:w-8 sm:h-8 transition-colors ${star <= activeRating
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-zinc-50/70 dark:bg-zinc-950/70 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-[#0066CC] dark:focus:border-[#0066CC] transition-colors placeholder:text-zinc-400 font-sans resize-none leading-relaxed"
              />
            </div>
            ...
            <button
              ...
              className="mt-2 w-full py-4 bg-[#0066CC] hover:bg-[#0052A3] disabled:opacity-50 text-white text-xs font-semibold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-md shadow-[#0066CC]/25 hover:shadow-lg hover:shadow-[#0066CC]/35 flex items-center justify-center gap-2 cursor-pointer"
            >
              {isSubmitting ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
