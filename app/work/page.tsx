...
export const metadata: Metadata = {
  ...
  description:
    'Galeri portofolio fotografi sinematik dan editorial Margasera Photography — "Moment Satu Hari Untuk Selamanya". Menampilkan dokumentasi Wedding, Pre-Wedding, Engagement, Siraman, Wisuda Outdoor, Sidang Skripsi, dan Tasyakuran Bayi di Pamekasan & Madura.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Galeri portofolio fotografi sinematik dan editorial Margasera Photography — "Moment Satu Hari Untuk Selamanya" di Pamekasan, Madura.',
    url: "/work",
...
export default async function WorkPage() {
  ...
  const jsonLd = {
    ...
    description:
      "Galeri portofolio fotografi sinematik dan editorial untuk wedding, pre-wedding story, couple, portrait, dan graduation di Pamekasan, Madura.",
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 pt-8 pb-20">
      ...
      <div className="text-center max-w-3xl mx-auto px-6 mb-8">
        ...
        <p className="text-sm text-zinc-400 font-light leading-relaxed mt-4">
          Jelajahi koleksi momen-momen terbaik di Pamekasan, Madura, dan
          sekitarnya yang kami abadikan dalam harmoni estetika sinematik,
          pencahayaan dramatis, dan komposisi editorial.
        </p>
      </div>
