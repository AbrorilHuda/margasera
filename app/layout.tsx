...
export const metadata: Metadata = {
  ...
  title: {
    default: "Margasera Photography - Fotografer Madura & Surabaya",
    template: "%s - Margasera Photography",
  },
  description:
    'Margasera Photography adalah fotografer profesional di Pamekasan, Madura dengan slogan "Moment Satu Hari Untuk Selamanya". Melayani Wedding, Pre-Wedding, Engagement, Siraman, Wisuda Outdoor, Sidang Skripsi, serta Tasyakuran 40 Hari Bayi.',
  keywords: [
  ...
  openGraph: {
    title: "Margasera Photography - Fotografer Madura & Surabaya",
    description:
      'Fotografer profesional di Pamekasan, Madura — "Moment Satu Hari Untuk Selamanya". Melayani Wedding, Pre-Wedding, Engagement, Siraman, Wisuda Outdoor, Sidang Skripsi, dan Tasyakuran 40 Hari Bayi.',
    url: siteUrl,
  ...
  twitter: {
    ...
    title: "Margasera Photography - Fotografer Madura & Surabaya",
    description:
      "Moment Satu Hari Untuk Selamanya — Fotografer profesional di Pamekasan, Madura.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      'Creative photography studio profesional di Pamekasan, Madura dengan slogan "Moment Satu Hari Untuk Selamanya". Melayani Wedding, Pre-Wedding, Engagement, Siraman, Wisuda Outdoor, Sidang Skripsi, serta Tasyakuran 40 Hari Bayi.',
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            name: "Wedding",
            description:
              "Dokumentasi sinematik momen pernikahan (Akad & Resepsi) dengan sentuhan editorial dan emosi timeless di Pamekasan & Madura.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            name: "Pre-Wedding",
            description:
              "Sesi foto pre-wedding intim berkonsep editorial di lokasi outdoor/studio pilihan di Madura dan sekitarnya.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            name: "Engagement",
            description:
              "Potret romantis dan momen lamaran / tunangan yang menangkap gestur alami pasangan.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            name: "Siraman",
            description:
              "Dokumentasi prosesi adat siraman sakral penuh kekhidmatan keluarga di Pamekasan & Madura.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            name: "Wisuda Outdoor",
            description:
              "Dokumentasi kelulusan outdoor estetik bersama keluarga dan kerabat terdekat.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            name: "Sidang Skripsi",
            description:
              "Abadikan momen bersejarah keberhasilan kelulusan ujian skripsi bersama sahabat dan keluarga.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Dokumentasi kehangatan masa kehamilan dan tasyakuran aqiqah / 40 hari kelahiran buah hati tercinta.",
          },
        },
      ],
    },
