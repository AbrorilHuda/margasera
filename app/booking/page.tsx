...
export const metadata = {
  ...
  description:
    "Formulir pemesanan online sesi fotografi wedding, pre-wedding story, couple, portrait, dan wisuda Margasera Photography Pamekasan Madura.",
  alternates: {
    canonical: "/booking",
  },
  openGraph: {
    ...
    description:
      "Pesan sesi foto wedding, pre-wedding, couple, portrait, dan wisuda secara online di Margasera Photography.",
    url: "/booking",
  },
};
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 pt-8 pb-20">
      <div className="text-center max-w-3xl mx-auto px-6 mb-4">
        ...
        <p className="text-sm text-zinc-400 font-light leading-relaxed mt-3">
          Ikuti langkah bertahap di bawah ini untuk memesan tanggal dan paket
          dokumentasi Anda.
        </p>
      </div>
