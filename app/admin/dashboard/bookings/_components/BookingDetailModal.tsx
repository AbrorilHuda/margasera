  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl max-w-lg w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden my-auto">
        ...
        <div className="p-4 sm:p-6 flex-1 overflow-y-auto flex flex-col gap-3 text-xs text-zinc-300 font-light">
          <Row label="Nama Pelanggan:">
            <strong className="text-zinc-100 text-sm font-semibold">{b.customerName}</strong>
          </Row>
          <Row label="WhatsApp:">
            <strong className="font-mono text-emerald-400">{b.whatsapp}</strong>
          </Row>
          {b.instagram && (
          ...
          <Row label="Layanan:">
            <strong className="text-zinc-200">{b.serviceName} ({b.packageName})</strong>
          </Row>
          ...
          <Row label="Lokasi / Venue:">
            <strong className="text-zinc-200">{b.location}</strong>
          </Row>
          <Row label="Total :">
          ...
          <div className="flex flex-col gap-2 pt-3 border-t border-zinc-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`py-2 text-xs font-semibold uppercase rounded-lg transition-all text-center flex items-center justify-center gap-1 ${isDpPaid || isPaidFull
              ...
              <button
                ...
                className={`py-2 text-xs font-semibold uppercase rounded-lg transition-all text-center flex items-center justify-center gap-1 ${isPaidFull
        ...
        <div className="p-4 sm:p-6 bg-zinc-900 border-t border-zinc-800 flex items-center gap-3 shrink-0 sticky bottom-0 z-10">
          <a
